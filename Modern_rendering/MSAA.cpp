...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "MSAA", nullptr, nullptr); // Windowed
    ...
    Shader shader("shader/cube.vs", "shader/cube.fs");
    Shader temp("shader/temp.vs", "shader/temp.fs");

    //#pragma region 预处理指令 折叠特定的代码块，从而使界面更加清洁
...
#pragma endregion
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 我们不能直接在片段着色器中使用多重采样的纹理，但我们能使用一个中介帧缓冲，在该缓冲中将其变成普通2D纹理
