...
int main()
{
    ...
    Shader pbrShader("shader/PBR_IBL/pbr.vs", "shader/PBR_IBL/pbr.fs");
    Shader equirectangularToCubemapShader("shader/PBR_IBL/cubemap.vs", "shader/PBR_IBL/equirectangular_to_cubemap.fs");
    Shader irradianceShader("shader/PBR_IBL/cubemap.vs", "shader/PBR_IBL/irradiance_convolution.fs");
    Shader prefilterShader("shader/PBR_IBL/cubemap.vs", "shader/PBR_IBL/prefilter.fs");
    Shader brdfShader("shader/PBR_IBL/brdf.vs", "shader/PBR_IBL/brdf.fs");
    Shader backgroundShader("shader/PBR_IBL/background.vs", "shader/PBR_IBL/background.fs");
